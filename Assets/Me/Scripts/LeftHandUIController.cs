...
public class LeftHandUIController : MonoBehaviour
{
    ...
    //TODO add animation, make this work
    private void TweenStuff() {
        //TODO change to button thumbstick left/right
        ...
        if (OVRInput.Get(OVRInput.Button.Three) && isAnimating == false)
        {
            ...
            if (panel1InFocus)
            {
                //   iTween.MoveTo(panel1, panel2StartPosition, animationTime, "onComplete", "OnAnimationComplete", "onCompleteTarget", gameObject);
            ...
            {
                //   iTween.MoveTo(panel1, panel1StartPosition, animationTime);
                iTween.MoveTo(panel1, iTween.Hash(panel2StartPosition, animationTime, "onComplete", "OnAnimationComplete", "onCompleteTarget", gameObject));
